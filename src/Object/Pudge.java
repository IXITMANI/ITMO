...
public class Pudge extends Persons {

    public Pudge(String name, Places place, int HP) {
        super(name, place);
        super.setHP(HP);
        super.MaxHP = HP;
        super.addItem(Items.MaskOfMadness);
        super.addItem(Items.ArmletOfMordiggian);
        super.addItem(Items.AghanimScepter);
        super.addItem(Items.BattleFury);
    }

    public void MeatHook(Persons person) {
    ...
    public void Dismember(Persons person) {
        person.damage(600);
